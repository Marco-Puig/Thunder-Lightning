...
class Pokemon_Effect
  ...
  def get_stealth_rock_dammages(pokemon)
    mod=$game_data_types[pokemon.type1].hit_by(13)*$game_data_types[pokemon.type2].hit_by(13)*$game_data_types[pokemon.type3].hit_by(13)*0.125
    return (pokemon.max_hp*mod).to_i
  end
