...
=begin
      ...
      text_dispose
      @button_validate.dispose
      @button_cancel.dispose
=begin
      Graphics.resize_screen(
        ::Config::Screen_Width * $zoom_factor,
        ::Config::Screen_Height * $zoom_factor
      )
=end
    end
...
=begin
    add_option(:screen_size, :screen_size_descr, [1, 2],
      [:screen_size_1, :screen_size_2],
      get_value: :screen_size_get,
      set_value: :screen_size_set
    )
=end
    ...
    def message_speed_set(value)
      $options.set_message_speed(value)
    end
    ...
    def battle_animation_set(value)
      $options.set_show_animation(value)
    end
    ...
    def screen_size_set(value)
      $options.set_zoom(value)
    end
