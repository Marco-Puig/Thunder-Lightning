  ...
  module MiningGame
    ...
    class Tool_Buttons < SpriteStack
      ...
      def initialize(viewport)
        ...
        @animation = nil
        nb_tool = $pokemon_party.mining_game.dynamite_unlocked ? 3 : 2
        coord_y = $pokemon_party.mining_game.dynamite_unlocked ? COORD_Y_3_TOOLS : COORD_Y_2_TOOLS
        @buttons = []
      ...
      def initial_coordinates
        if $pokemon_party.mining_game.dynamite_unlocked
          return 273, 52
        else
          return 273, 76
        end
