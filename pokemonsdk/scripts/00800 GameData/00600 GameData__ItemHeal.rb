...
module GameData
  ...
  class ItemHeal < Base
    ...
    # Index of the stat that receive +10 EV (boost_stat < 10) or +1 EV (boost_stat >= 10, index = boost_stat % 10). See GameData::EV to know the index
    ...
    # @param id [Integer] id of the heal item in the database
    # @return [Integer]
    def self.hp(id)
